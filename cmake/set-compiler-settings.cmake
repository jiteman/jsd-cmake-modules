...
if ( UNIX )
	...
	include( ${JSD_CMAKE_PATH}/compiler-settings/set-linux-C-compiler-settings.cmake )
	include( ${JSD_CMAKE_PATH}/compiler-settings/set-linux-C++-compiler-settings.cmake )

elseif( WIN32 )
	JSD_SHOW_BUILD_MESSAGE( "[JSD] COMPILER SETTINGS: Windows" )
	include( ${JSD_CMAKE_PATH}/compiler-settings/set-windows-C-compiler-settings.cmake )
	include( ${JSD_CMAKE_PATH}/compiler-settings/set-windows-C++-compiler-settings.cmake )
